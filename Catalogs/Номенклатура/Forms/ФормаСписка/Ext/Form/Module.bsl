...
Процедура Номенклатура_ОбработкаОповещенияПосле(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия = "ЗакрытДокумент" Тогда
		Если ДокументОткрытый = Параметр Тогда
			ДокументОткрытый = Неопределено;
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура Номенклатура_ОформитьЗаказПокупателяПосле(Команда)
	СоздатьДокумент("ЗаказПокупателя");
КонецПроцедуры

&НаКлиенте
Процедура Номенклатура_ОформитьЗаказПоставщикуПосле(Команда)
	СоздатьДокумент("ЗаказПоставщику");
КонецПроцедуры

&НаКлиенте
Процедура Номенклатура_ОформитьРеализацияТоваровПосле(Команда)
	СоздатьДокумент("РеализацияТоваров");
КонецПроцедуры

&НаКлиенте
Процедура Номенклатура_ОформитьПоступлениеТоваровПосле(Команда)
	СоздатьДокумент("ПоступлениеТоваров");
КонецПроцедуры

&НаКлиенте
Процедура Номенклатура_ОформитьЧекККМПосле(Команда)
...
Процедура ОткрытьКорзинуПродолжить(ПараметрыКорзины)
	...
	ОткрытьФорму(
		"Справочник.Номенклатура.Форма.ФормаКорзина",
...
Процедура ДобавитьНоменклатуруВКорзинуЗапроситьКоличество(СтруктураВыбора)
	...
	Если СтруктураВыбора.ЗапрашиватьКоличество Тогда
		ОткрытьФорму(
			"Справочник.Номенклатура.Форма.ФормаКоличествоУпаковок", 
			СтруктураВыбора,
			ЭтотОбъект,
			,
			,
