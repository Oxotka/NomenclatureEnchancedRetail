...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Установим отборы для остатков
	Номенклатура = Параметры.Номенклатура;
	Если ТипЗнч(Параметры.ОтборСклад) = Тип("СписокЗначений") Тогда
		ОтборСклад = Параметры.ОтборСклад.ВыгрузитьЗначения();
	Иначе
		ОтборСклад = Параметры.ОтборСклад;
	КонецЕсли;
	
	ОтборВидЦены = Параметры.ВидЦены;
	Элементы.Цена.Видимость = ЗначениеЗаполнено(ОтборВидЦены);
	Элементы.СвободныйОстаток.Видимость = Параметры.ПоказыватьСвободныеОстатки;
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "Номенклатура", Номенклатура, Истина);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ОтборСклад",   ОтборСклад,   Истина);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ВидЦены",      ОтборВидЦены, Истина);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ПоказыватьСвободныеОстатки", Параметры.ПоказыватьСвободныеОстатки, Истина);
	
	Если Параметры.Свойство("ПросмотрОстатков") И Параметры.ПросмотрОстатков Тогда
